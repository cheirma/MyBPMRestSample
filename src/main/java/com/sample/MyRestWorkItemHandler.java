 ...
 * </ul>
 */
public class MyRestWorkItemHandler extends AbstractLogOrThrowWorkItemHandler {
    
    private static final Logger logger = LoggerFactory.getLogger(MyRestWorkItemHandler.class);
	 ...
	 */
	public MyRestWorkItemHandler(String username, String password) {
		this();
	 ...
	 * @param authUrl
	 */
	public MyRestWorkItemHandler(String username, String password, String authUrl) {
		this();
		this.username = username;
		this.password = password;
     ...
     * Used when no authentication is required
     */
    public MyRestWorkItemHandler(ClassLoader classLoader) {
        logger.debug("REST work item handler will use http client 4.3 api " + HTTP_CLIENT_API_43);
        this.type = AuthenticationType.NONE;
     ...
     * @param password - password to be used for authentication
     */
    public MyRestWorkItemHandler(String username, String password, ClassLoader classLoader) {
        this();
        this.username = username;
        this.password = password;
        this.type = AuthenticationType.BASIC;
     ...
     * @param authUrl
     */
    public MyRestWorkItemHandler(String username, String password, String authUrl, ClassLoader classLoader) {
        this();
        this.username = username;
        this.password = password;
        this.type = AuthenticationType.FORM_BASED;
